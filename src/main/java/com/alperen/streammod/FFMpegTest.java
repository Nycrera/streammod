...
public class FFMpegTest {
	 ...
	 * @param PriorityMetadata a string containing the priority information to be
	 *                         added to metadata
	 */
	...
	public static void StreamVideo(String FileName, String ClientIP, String ClientPort) throws Exception {
		...
		// I should probably construct these URIs better with some checks etc. Just
		// concatenating is really messy.
